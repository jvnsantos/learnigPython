...
print("Salario bruto: R$", round(salarioMes, 3))
print("Desconto do INSS (8%): R$", round(inss,3))
print("Desconto do Sindicato (5%): R$" , round(sindicato,3))
print("Salario liquido: R$", round(salarioMes - inss - sindicato , 3))